 ...
 * FTP server. Because there is no standard representation for file information
 * on FTP servers, it may not always be possible to extract all the information
 * that can be represented by FTPFile, or it may even be possible to extract
 * more information. In cases where more information can be extracted, you will
 * want to subclass FTPFile and implement your own
 * {@link org.apache.commons.net.ftp.FTPFileListParser} to extract the
 * information. However, most FTP servers return file information in a format
 * that can be completely parsed by
 * {@link org.apache.commons.net.ftp.DefaultFTPFileListParser} and stored in
 * FTPFile.
 * <p>
 * <p>
 * 
...
public class FTPFile implements Serializable {
	...
	/***
	 * Returns a string representation of the FTPFile information. This will be
	 * the raw FTP server listing that was used to initialize the FTPFile
	 * instance.
	 * <p>
	 * 
